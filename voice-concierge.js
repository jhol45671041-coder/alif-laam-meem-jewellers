...
async function answer(question) {
  ...
  if (query.includes('price') || query.includes('cost') || query.includes('how much')) return 'All our jewellery is made to order and priced at the day’s 21K gold rate. Message us on WhatsApp from the collection page for today’s exact price and availability.';
  if (query.includes('ring') || query.includes('necklace') || query.includes('earring') || query.includes('jhumka') || query.includes('bangle') || query.includes('bracelet')) return 'Every piece in our edit is crafted in 21K gold and available by WhatsApp enquiry — message us for today’s figure. Return to the collection page to filter rings, necklaces, earrings, bangles, or bridal jewellery.';
  ...
  return 'I can help with 21K jewellery, prices, live gold rates, bridal pieces, bespoke designs, and showroom visits. What would you like to know?';
}
