...
async function answer(question) {
  ...
  if (query.includes('ring') || query.includes('necklace') || query.includes('earring') || query.includes('jhumka') || query.includes('bangle') || query.includes('bracelet')) return 'Every piece in our edit is crafted in 21K gold and shown in PKR. Return to the collection page to filter rings, necklaces, earrings, bangles, or bridal jewellery.';
  ...
  return 'I can help with 21K jewellery, PKR pricing, live gold rates, bridal pieces, bespoke designs, and showroom visits. What would you like to know?';
}
