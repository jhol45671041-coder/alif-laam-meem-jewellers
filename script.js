const products = [
  ...
  { id: 32, name: 'Aurora Halo Ring', category: 'Rings', type: 'Champagne diamond ring', weight: 6.3, image: 'public/images/ring-aurora.png', tag: 'NEW', description: 'A warm champagne diamond surrounded by a fine halo, designed to catch the light from every angle.' },
  { id: 33, name: 'Mehfil Emerald Signet', category: 'Rings', type: 'Emerald signet ring', weight: 8.1, image: 'public/images/ring-mehfil.png', tag: 'NEW', description: 'A deep emerald cabochon gives this hand-finished signet a quietly ceremonial presence.' },
  { id: 34, name: 'Sahar Pearl Band', category: 'Rings', type: 'Pearl & diamond ring', weight: 5.7, image: 'public/images/ring-sahar.png', tag: 'NEW', description: 'A luminous pearl and tiny diamonds make this fine gold band an easy everyday signature.' },
  { id: 35, name: 'Aurora Evening Ring', category: 'Rings', type: 'Champagne diamond ring', weight: 6.8, image: 'public/images/ring-aurora-detail.jpg', tag: '', description: 'The Aurora silhouette in a closer, more sculptural expression for evenings worth remembering.' },
  { id: 36, name: 'Mehfil Profile Ring', category: 'Rings', type: 'Emerald signet ring', weight: 8.6, image: 'public/images/ring-mehfil-profile.jpg', tag: '', description: 'A softly rounded emerald signet with a profile made for stacking or standing alone.' },
  { id: 37, name: 'Sahar Stacking Band', category: 'Rings', type: 'Pearl stackable ring', weight: 4.9, image: 'public/images/ring-sahar-stack.jpg', tag: 'NEW', description: 'A slimmer companion to the Sahar pearl band, made to add a little light to your stack.' },
  { id: 38, name: 'Mahro Link Collar', category: 'Necklaces', type: 'Gold link necklace', weight: 29.6, image: 'public/images/necklace-mahro.png', tag: 'NEW', description: 'Repeating curved links give this 21K collar a confident line and a beautiful sense of movement.' },
  { id: 39, name: 'Gulrukh Ruby Garland', category: 'Necklaces', type: 'Ruby floral necklace', weight: 42.2, image: 'public/images/necklace-gul.png', tag: 'NEW', description: 'Ruby-red floral colour and soft gold come together in a necklace made for celebration.' },
  { id: 40, name: 'Aayat Emerald Pendant', category: 'Necklaces', type: 'Emerald gold pendant', weight: 6.4, image: 'public/images/necklace-aayat.png', tag: 'NEW', description: 'A small emerald pendant with an easy chain, made to stay close to your everyday.' },
  { id: 41, name: 'Mahro Layered Collar', category: 'Necklaces', type: 'Gold link necklace', weight: 33.1, image: 'public/images/necklace-mahro-detail.jpg', tag: '', description: 'A more generous take on the Mahro collar, with layered links that hold the light beautifully.' },
  { id: 42, name: 'Gulrukh Pearl Garland', category: 'Necklaces', type: 'Ruby & pearl necklace', weight: 45.8, image: 'public/images/necklace-gul-detail.jpg', tag: '', description: 'A closer variation of the Gulrukh garland, finished with a softer fall of pearls.' },
  { id: 43, name: 'Aayat Coin Pendant', category: 'Necklaces', type: 'Engraved gold pendant', weight: 7.2, image: 'public/images/necklace-aayat-detail.jpg', tag: '', description: 'A small golden pendant with an intimate, talisman-like quality for daily wear.' },
  { id: 44, name: 'Zara Pearl Jhumkas', category: 'Earrings', type: 'Gold pearl jhumkas', weight: 14.1, image: 'public/images/earrings-zara.png', tag: 'NEW', description: 'A joyful pair of pearl-fringed jhumkas with the warmth and rhythm of classic goldwork.' },
  { id: 45, name: 'Noor Pavé Hoops', category: 'Earrings', type: 'Diamond hoop earrings', weight: 7.6, image: 'public/images/earrings-noor.png', tag: 'NEW', description: 'Polished gold hoops with a fine line of diamonds for a little light, every day.' },
  { id: 46, name: 'Mehr Floral Drops', category: 'Earrings', type: 'Ruby & emerald earrings', weight: 12.7, image: 'public/images/earrings-mehr.png', tag: 'NEW', description: 'Floral drops with ruby and emerald colour, made to move gently as you do.' },
  { id: 47, name: 'Zara Celebration Jhumkas', category: 'Earrings', type: 'Gold pearl jhumkas', weight: 15.3, image: 'public/images/earrings-zara-detail.jpg', tag: '', description: 'A fuller Zara silhouette with an extra touch of pearl movement for special occasions.' },
  { id: 48, name: 'Noor Evening Hoops', category: 'Earrings', type: 'Diamond hoop earrings', weight: 8.4, image: 'public/images/earrings-noor-detail.jpg', tag: '', description: 'A softly sculpted hoop with a little more presence for the hours after sunset.' },
  { id: 49, name: 'Mehr Garden Drops', category: 'Earrings', type: 'Ruby & emerald earrings', weight: 13.5, image: 'public/images/earrings-mehr-detail.jpg', tag: '', description: 'The Mehr floral drop in a rich garden palette, balanced for a graceful occasion look.' },
  { id: 50, name: 'Ruhi Sculpted Bangle', category: 'Bangles', type: 'Twisted gold bangle', weight: 24.6, image: 'public/images/bangle-ruhi.png', tag: 'NEW', description: 'A softly twisted bangle with a sculptural surface and the generous warmth of 21K gold.' },
  { id: 51, name: 'Ruhi Golden Twist', category: 'Bangles', type: 'Twisted gold bangle', weight: 27.2, image: 'public/images/bangle-ruhi-detail.jpg', tag: '', description: 'A more substantial Ruhi silhouette for a stack with presence and a beautiful golden rhythm.' },
  { id: 52, name: 'Yaara Detail Bracelet', category: 'Bangles', type: 'Diamond line bracelet', weight: 13.1, image: 'public/images/bracelet-yaara-detail.jpg', tag: 'NEW', description: 'A close-set line of diamond light, made to sit effortlessly beside the pieces you already wear.' },
  { id: 53, name: 'Amaan Charm Bracelet', category: 'Bangles', type: 'Gold charm bracelet', weight: 8.9, image: 'public/images/pendant-amaan-detail.jpg', tag: '', description: 'A small talisman-like charm reimagined as a bracelet for everyday closeness.' },
