...
The site includes 15 HTML pages:
...
The collection pages share `pages.css` and `pages.js` for the responsive layout, navigation, reveal animations, collection filters, WhatsApp enquiries, and form feedback. Run locally with `python3 -m http.server 4173` from the repository root.
